...
## Prerequisites
- Attend live or watch a recording of the Devtoberfest session [🟠 Using UI5 Web Components with Svelte](https://groups.community.sap.com/t5/devtoberfest/using-ui5-web-components-with-svelte/ec-p/283232#M360).
